...
public class MainActivity extends AppCompatActivity {
    ...
    static String shared_data = "file";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sp_s = getSharedPreferences(shared_data, 0);
    ...
    protected void onDestroy() { // 앱이 종료 되었을 때
        super.onDestroy();
        /* sharedPreferences */ // 앱 내부 데이터를 file로 저장, 불러오기
        SharedPreferences sp_e = getSharedPreferences(shared_data, 0);
